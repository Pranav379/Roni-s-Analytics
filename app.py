...
if page == "🏠 Home":
    ...
    Developed for the Roni's Challenge for Tamu Datathon 2024
    """)
...
if page == "📊 Parent Menu Order Totals":
    ...
    for better stock and preparation planning. Tracking these totals over time allows for adjustment to menu offerings and highlight 
    ...
    help optimize staff scheduling and inventory. Tracking these trends allows for planning promotions, anticipating busy 
    times, and better aligning resources with demand patterns throughout the day.
